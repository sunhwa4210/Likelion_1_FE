...
import CurationScrapButton2 from "./CurationScrapButton2";
    ...
    >
      ...
      <div className={styles.curationContent}>
        ...
        <div className={styles.curationFooter}>
          ...
          initialLiked={liked}
          onChange={(data) => onLikeChange(id, data.likeCount, data.liked)}
        />
        </div>
      </div>
    </div>
