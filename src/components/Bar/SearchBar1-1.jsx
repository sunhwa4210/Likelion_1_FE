...
function SearchBar1_1({ maxWidth = '347px', onFilterClick, onSearchChange, onSortChange,
  ...
  const handleSortClick = (key) => {
        ...
        // ⭐️ 내부 상태 업데이트 대신, 부모에게 값 변경을 알립니다.
  ...
  const handleSearchInputChange = (e) => {
        ...
        // ⭐️ searchTerm 상태 대신, 부모 컴포넌트에게 변경을 알립니다.
      ...
      > 
        ...
        <div className={styles.sortFilterArea}>
          ...
          <div className={styles.sortOptions}>
            ...
            <SortComments 
              isActive={externalActiveSort === 'comments'}
